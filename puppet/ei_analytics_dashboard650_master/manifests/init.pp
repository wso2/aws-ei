...
# Class: ei_analytics_dashboard650_master
# Init class of Enterprise Integrator Analytics - dashboard profile
class ei_analytics_dashboard650_master inherits ei_analytics_dashboard650_master::params {
  ...
  file { "${distribution_path}/${product}-${product_version}/wso2/analytics/lib/${db_connector}":
    owner  => $user,
    group  => $user_group,
    mode   => '0754',
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_analytics_dashboard650_master -> files
  */
