...
export FACTER_profile=ei_broker650_master
puppet agent -vt
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/ei_broker650/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/ei_broker580_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
