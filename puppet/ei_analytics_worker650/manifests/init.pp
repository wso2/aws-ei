...
# Class: ei_analytics_worker650
# Init class of Enterprise Integrator Analytics - Worker profile
class ei_analytics_worker650 inherits ei_analytics_worker650::params {
  ...
  */
  ...
  file { "binary":
    ...
    group  => $user_group,
    mode   => '0644',
    source => "puppet:///modules/ei_analytics_worker650/${product_binary}",
  }
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_analytics_worker650 -> files
  */
