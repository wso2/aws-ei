...
export FACTER_profile=ei_analytics_worker650_master
puppet agent -vt
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/ei_analytics_worker650/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/ei_analytics650_worker_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
