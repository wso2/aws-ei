...
# Class: ei_analytics_worker650_master
# Init class of Enterprise Integrator Analytics - Worker profile
class ei_analytics_worker650_master inherits ei_analytics_worker650_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_analytics_worker650_master -> files
  */
