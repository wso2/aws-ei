...
# Class: ei_analytics_dashboard650
# Init class of Enterprise Integrator Analytics - Dashboard profile
class ei_analytics_dashboard650 inherits ei_analytics_dashboard650::params {
  ...
  */
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_analytics_dashboard650 -> files
  */
