...
# Class: ei_integrator650_master
# Init class of EI Integrator default profile
class ei_integrator650_master inherits ei_integrator650_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_integrator650_master -> files
  */
